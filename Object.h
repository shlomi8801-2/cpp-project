...
public:
    object() {};
    inline object(char _sprite, bool _filled = false, bool _pickable = false, bool _visible = false,
                  int _type = 0, int _doorId = 0, int _keyId = 0, int _switchId = 0, int _riddleId = 0) {
        Sprite = _sprite;
        filled = _filled;
        pickable = _pickable;
        visible = _visible;
